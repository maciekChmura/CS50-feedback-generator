...
const data = {
  "professional skills": {
    poor: [
      `${name} has made frequent errors that are harmful to business operations.`,
      `The supervisor head has received numerous complaints about ${name} and the quality of ${
        gender === 0 ? "his" : "her"
      } work.`,
      `The quality of work produced by ${name} is unacceptable.`,
      `${name} does not complete ${
        gender === 0 ? "his" : "her"
      } required tasks.`
    ],
    "needs improvement": [
      `${name} is not as careful in checking work product for errors as ?G could be.`,
      `${name} tends to miss small errors in work product.`,
      `${name} required paperwork is completed late or is only partially complete.`
    ],
    "meets requirements": [
      `${name} does not require constant supervision, and performs ?G work correctly`,
      `${name} error rate is acceptable, and all work is completed timely.`,
      `${name} performs all tasks on time with acceptable amount of errors.`
    ],
    "exceeds requirements": [
      `${name} managers and co-workers have commented on high levels of ?G accuracy and work productivity.`,
      `${name} takes pride in work and strives to improve ?G work performance.`,
      `Many time work done by ${name} exceeds requirements. All task are performed with best practices`
    ],
    outstanding: [
      `${name} has less than a 1% error rate on work product.`,
      `${name} accuracy is excellent.`,
      `Work produced by ${name} is outstanding and above all requirements.`
    ]
  },
  "quality of work": {
    poor: [
      ...
      `Sees ${
        gender === 0 ? "his" : "her"
      } personal output slipping and does nothing to stop it. Interferes with the performance of others`,
      `Displays disruptive or distracting behaviors. Often needs to redo ${
        gender === 0 ? "his" : "her"
      } work`,
    ...
    "needs improvement": [
      ...
      `Bogs down performance and productivity with ${
        gender === 0 ? "his" : "her"
      } misdirected actions`,
    ...
    "meets requirements": [
      ...
      `Has been improving ${
        gender === 0 ? "his" : "her"
      } productivity. Understands how to produce more. Puts in extra hours to get the desired results`,
    ...
    "exceeds requirements": [
      ...
      `Takes on any task. Is productive beyond standard requirements. Ties the employees' performance to the overall company performance in order to make them feel responsible for producing quality work. Single-handedly led to the success of the XYZ project through ${
        gender === 0 ? "his" : "her"
      } efforts`,
    ...
    outstanding: [
      ...
      `Dazzles everyone with the quality and quantity of ${
        gender === 0 ? "his" : "her"
      } work. Is productivity minded`,
  ...
  "attitude and dedication": {
    poor: [
      `${name} is always late to work. Often takes long to come back to the office after breaks`,
    ...
    "needs improvement": [
      `${name} takes more time than necessary to complete a meeting`,
      `Gives all the tasks intermittent attention rather than concentrated attention`,
      `${name} is sometimes late to work`
    ],
    "meets requirements": [
      `${name} attends all the team meetings. Always willing to accept extra assignments without counting how much more work is ahead`,
  ...
  "self development": {
    poor: [
      ...
      `Accepts no responsibility for setting ${
        gender === 0 ? "his" : "her"
      } own personal goals`,
    ...
    "needs improvement": [
      `Sets personal goals, but none that would enhance ${
        gender === 0 ? "his" : "her"
      } performance on the job`,
      `Takes no serious steps to meet ${
        gender === 0 ? "his" : "her"
      } personal goals`,
      `Sets very general personal goals`,
      `Sets unchallenging personal goals`,
      `Hasn’t made a serious commitment to meeting ${
        gender === 0 ? "his" : "her"
      } personal goals`,
    ...
    "meets requirements": [
      `Takes ${
        gender === 0 ? "his" : "her"
      } personal goals seriously. Listens to counsel from others regarding her personal goals and the best strategies to meet them`,
      `Sets challenging yet realistic goals regarding ${
        gender === 0 ? "his" : "her"
      } skills, education, and career`,
      `Has established personal goals and a path to meet them`,
      `Obtains the training that is needed to achieve ${
        gender === 0 ? "his" : "her"
      } personal goals`,
      `Helps other employees determine their personal goals`,
      `Shows a high degree of tenacity in pursuing ${
        gender === 0 ? "his" : "her"
      } personal goals`
    ],
    "exceeds requirements": [
      ...
      `Has attained ${
        gender === 0 ? "his" : "her"
      } personal goals, which has led to markedly improved performance`,
      `Sets goals that are all accompanied by well-designed action plans`,
      `Devotes major effort to reaching ${
        gender === 0 ? "his" : "her"
      } personal goals`,
      `Is able to meet ${
        gender === 0 ? "his" : "her"
      } personal goals while also meeting ${
        gender === 0 ? "his" : "her"
      } performance goals`,
      `Continues to set increasingly challenging personal goals`,
      `Shows great confidence regarding ${
        gender === 0 ? "his" : "her"
    ...
    outstanding: [
      `Has a clear vision of ${
        gender === 0 ? "his" : "her"
      } future and works diligently to make it a reality`,
      ...
      `Consistently meets ${
        gender === 0 ? "his" : "her"
      } personal objectives and then sets new ones that are even more challenging`,
      `Establishes clear and challenging short-term and long-term personal goals`,
      `Demonstrates great initiative and energy in pursuing ${
        gender === 0 ? "his" : "her"
      } personal goals`
    ]
  },
